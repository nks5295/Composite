...
/*-----------------------------------------------------------*/
	...
	BaseType_t xQueueTakeMutexRecursive( QueueHandle_t xMutex, TickType xTicksToWait )
	{
	BaseType_t xReturn;
	Queue_t * const pxMutex = ( Queue_t * ) xMutex;
...
BaseType_t xQueueGenericSend( QueueHandle_t xQueue, const void * const pvItemToQueue, TickType xTicksToWait, const BaseType_t xCopyPosition )
{
...
BaseType_t xQueueGenericReceive( QueueHandle_t xQueue, void * const pvBuffer, TickType xTicksToWait, const BaseType_t xJustPeeking )
{
BaseType_t xEntryTimeSet = pdFALSE;
TimeOut_t xTimeOut;
int8_t *pcOriginalReadPosition;
...
/*-----------------------------------------------------------*/
	...
	void vQueueWaitForMessageRestricted( QueueHandle_t xQueue, TickType xTicksToWait )
	{
	Queue_t * const pxQueue = ( Queue_t * ) xQueue;
