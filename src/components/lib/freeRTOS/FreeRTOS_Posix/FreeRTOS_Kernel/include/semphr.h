...
#define semGIVE_BLOCK_TIME					( ( TickType ) 0U )
 ...
 * Example usage:
 ...
 void vAnotherTask( void * pvParameters )
 {
    ...
    if( xSemaphore != NULL )
    {
        ...
        if( xSemaphoreTake( xSemaphore, ( TickType ) 10 ) == pdTRUE )
        {
 ...
 * Example usage:
 ...
 void vAnotherTask( void * pvParameters )
 {
    ...
    if( xMutex != NULL )
    {
        ...
        // wait 10 ticks to see if it becomes free.
        if( xSemaphoreTakeRecursive( xSemaphore, ( TickType ) 10 ) == pdTRUE )
        {
            ...
            xSemaphoreTakeRecursive( xMutex, ( TickType ) 10 );
            xSemaphoreTakeRecursive( xMutex, ( TickType ) 10 );
 ...
 * Example usage:
 ...
 void vATask( void * pvParameters )
 {
    ...
    if( xSemaphore != NULL )
    {
        ...
        if( xSemaphoreTake( xSemaphore, ( TickType ) 0 ) )
        {
 ...
 * Example usage:
 ...
 void vAnotherTask( void * pvParameters )
 {
    ...
    if( xMutex != NULL )
    {
        // See if we can obtain the mutex.  If the mutex is not available
        // wait 10 ticks to see if it becomes free.
        if( xSemaphoreTakeRecursive( xMutex, ( TickType ) 10 ) == pdTRUE )
        {
            // We were able to obtain the mutex and can now access the
            // shared resource.
